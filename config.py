...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/pintujani/Pintu-Jani",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/dpzt5p.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/dpzt5p.jpg"
)
...
if SUPPORT_CHANNEL:
    if not re.match("(?:http|https)://", https://t.me/CHOCO_MUSIC_P:
        raise SystemExit(
            "[ERROR] - Your SUPPORT_CHANNEL url is wrong. Please ensure that it starts with https://"
        )

if SUPPORT_CHAT:
    if not re.match("(?:http|https)://", https://t.me/+ny5_c-2X1QQ5MmE0:
        raise SystemExit(
